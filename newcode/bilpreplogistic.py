...
def test(prep, model):
    ...
    teX, teY, teV, teN, teP, teM = dataextractTest(pp=prep)
    toperator = Bilnear(teX, teV, teN, teM, teP, teY)
...
#   foutfile = open('output.txt', 'w', buffsize)
    trX, trY, trV, trN, trP, trM, deX, deY, deV, deN, deP, deM = dataextract(pp=prep)
